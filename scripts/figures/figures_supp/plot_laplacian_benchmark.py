...
if __name__ == "__main__":
    times = pd.read_csv("results/laplacian_times.csv", index_col=0)
    ...
    fig.tight_layout()
    fig.savefig("figures/laplacian_times.png", dpi=300)
    fig.savefig("figures/laplacian_times.svg", dpi=300)
