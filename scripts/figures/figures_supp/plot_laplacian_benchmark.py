...
if __name__ == "__main__":
    times = pd.read_csv("results/times_laplacian_operator.csv", index_col=0)
    ...
    palette = {"Linear Operator": "black", "Sparse matrix": "grey"}
    variables = {
        "matvec_time": "Matrix-vector product time (s)",
        "overhead_time": "Laplacian building time (s)",
    ...
    fig.tight_layout()
    fig.savefig("figures/times_laplacian_operator.png", dpi=300)
    fig.savefig("figures/times_laplacian_operator.svg", dpi=300)
