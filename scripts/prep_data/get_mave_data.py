...
if __name__ == "__main__":
    ...
    print('Estimating measurement variance')
    df = pd.melt(
    ...
    msg = "\tSplit into {} sequences for training and {} for testing"
    print(msg.format(train.shape[0], test.shape[0]))
